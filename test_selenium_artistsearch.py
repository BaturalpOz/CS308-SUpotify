...
class ArtistSearchTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.driver.get('http://localhost:8000/artistsearch.html')  # HTML dosya yolu güncellenmeli

    def test_page_load(self):
        # Sayfanın başarıyla yüklendiğini kontrol et
        self.assertIn("Artist Search", self.driver.title)
    ...
    def test_artist_search_functionality(self):
        ...
        test_artist_name = "Buray"  # Gerçek bir sanatçı adıyla değiştirin
        search_box.send_keys(test_artist_name)
        search_button.click()
