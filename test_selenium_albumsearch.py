...
class ArtistSearchTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.driver.get('http://localhost:8000/albumsearch.html')  # HTML dosya yolu güncellenmeli

    def test_page_load(self):
        # Sayfanın başarıyla yüklendiğini kontrol et
        self.assertIn("Album Search", self.driver.title)
    ...
    def test_artist_search_functionality(self):
        ...
        test_album_name = "BERCESTE"  # Gerçek bir sanatçı adıyla değiştirin
        search_box.send_keys(test_album_name)
        search_button.click()
